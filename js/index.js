...
$.ajax(
    {
        type:'get',
        url : sameUrl+'/getHotelInfo',
        dataType:'jsonp',
        jsonp: 'callback',
        jsonpCallback:'hotel_jsoncallback',
...
$.ajax({
    type:'get',
    url : sameUrl+'/getRoomTypeList',
    dataType:'jsonp',
    jsonp: 'callback',
    jsonpCallback:'roomtype_jsoncallback',
    success:function(result){
        if(result.resultId==1){
...
$(".room-type-box").on("click",".room-type-info",function(){
    ...
    $.ajax({
        type:"post",
        url:sameUrl+"/getRoomTypeById",
        data:{"roomtypeId":roomtypeId},
        dataType:"jsonp",
        jsonp: 'callback',
        jsonpCallback:'roomdetail_jsoncallback',
        success:function(result){
            if(result.resultId==1){
                //房型名称
